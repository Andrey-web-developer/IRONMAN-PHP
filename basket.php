      ...
      <div class="container">
        ...
        <div class="row justify-content-between basket__container">
          ...
          <div class="col-md-7 col-xxl-5">
            ...
            <form action="#" class="basket__form form">
              <input type="text" aria-label="Введите промокод" placeholder="Промокод"
                class="form__input basket__input input-reset">
        ...
        <div class="row">
          <div class="col basket__wrapper">
            <ul class="d-none d-md-flex basket__title-list list-reset">
              <li class="basket__title-item">
                <h3 class="basket__title-item-subtitle">Наименование</h3>
              </li>
              <div class="col-7 basket__inner basket__inner--title">
                <li class="col-6 col-md-5 col-lg-3 basket__title-item">
                  <h3 class="basket__title-item-subtitle">Цена</h3>
                  <span class="d-none d-lg-block">Без скидки</span>
                </li>
                <li class="col-3 d-none d-lg-block basket__title-item">
                  <h3 class="basket__title-item-subtitle">Цена</h3>
                  <span>С учетом скидки</span>
                </li>
                <li class="col-5 col-lg-3 basket__title-item">
                  <h3 class="basket__title-item-subtitle">Кол-во</h3>
                  <span>Шт.</span>
                </li>
                <li class="col-2 d-none d-lg-block basket__title-item">
                  <h3 class="basket__title-item-subtitle">Вес</h3>
                  <span>Кг</span>
                </li>
                <li class="d-none d-md-block col-auto basket__title-item">
                      ...
                      <div class="col-4 col-sm-3 col-md-5 col-lg-3 basket__stepper">
                        <div class="stepper__wrapper">
                          ...
                          <div class="stepper__buttons">
                            <button class="stepper__button stepper__button--up btn-reset"
                            ...
                            <button class="stepper__button stepper__button--down stepper__button--disabled btn-reset"
            ...
            <ul class="basket__title-list basket__title-list--bottom list-reset">
            ...
            <ul class="basket__list basket__title-list--total list-reset">
              <li class="basket__title-item">
                <h3 class="basket__title-item-subtitle">Итого</h3>
              </li>
              <div class="col-9 col-md-7 basket__inner">
                <li class="col-3 col-sm-4 col-lg-3 basket__title-item">3</li>
                <li class="col-2 col-sm-3 col-md-3 col-lg-2 basket__title-item">1,5</li>
                <li class="col-3 col-sm-2 col-md-2 col-lg-1 basket__title-item">1800</li>
              </div>
            </ul>
