              ...
              <div class="form__wrapper">
                <ul class="nav nav-tabs tab__wrapper" id="myTab" role="tablist">
                  <li class="nav-item" role="presentation">
                    <button class="nav-link active btn-reset" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">E-mail</button>
                  </li>
                  <li class="nav-item" role="presentation">
                    <button class="nav-link btn-reset" id="phone-tab" data-bs-toggle="tab" data-bs-target="#phone" type="button" role="tab" aria-controls="phone" aria-selected="false">Телефон</button>
                  </li>
                </ul>
                ...
                <input type="password" aria-label="Введите пароль" placeholder="Пароль" class="form__input input-reset">
          ...
          <form action="#" class="authorization__form form">
            <fieldset class="form__list">
              ...
              <div class="form__wrapper">
                ...
                <input type="email" aria-label="Введите E-mail" placeholder="E-mail" class="form__input input-reset">
                <input type="password" aria-label="Введите пароль" placeholder="Пароль" class="form__input input-reset">
                <input type="password" aria-label="Повторите пароль" placeholder="Повторите пароль" class="form__input input-reset">
