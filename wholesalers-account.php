            ...
            <ul class="wholesalers-account__list list-reset">
              <li class="wholesalers-account__item mb-4 mb-lg-0">
                <div class="wholesalers-account__container">
                  ...
                  <button class="wholesalers-account__change btn-reset" data-bs-toggle="modal"
                    data-bs-target="#user-data" aria-label="Нажмите, чтобы изменить данные">
                  ...
                  <div class="modal fade" id="user-data" tabindex="-1" aria-labelledby="Введите ваши данные"
                    aria-hidden="true">
                        ...
                        <div class="modal-body">
                          <form action="#" class="modal-form">
                            <div class="form__wrapper">
                              <input type="text" aria-label="Введите фамилию" placeholder="Фамилия"
                                class="form__input input-reset">
                              <input type="text" aria-label="Введите имя" placeholder="Имя"
                                class="form__input input-reset">
                              <input type="text" aria-label="Введите отчество" placeholder="Отчество"
                                class="form__input input-reset">
                              <input type="password" aria-label="Введите старый пароль" placeholder="Старый пароль"
                                class="form__input input-reset">
                              <input type="password" aria-label="Введите новый пароль" placeholder="Новый пароль"
                                class="form__input input-reset">
                              ...
                              <div class="modal-footer">
                                ...
                                <button class="form__button form__button--close button btn-reset"
            ...
            <ul class="wholesalers-account__list list-reset">
              <li class="wholesalers-account__item">
                <div class="wholesalers-account__container">
                  ...
                  <button class="wholesalers-account__change btn-reset" data-bs-toggle="modal" data-bs-target="#address"
                    aria-label="Нажмите, чтобы изменить данные">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path fill-rule="evenodd" clip-rule="evenodd"
                        d="M12 24C18.6274 24 24 18.6274 24 12C24 5.37258 18.6274 0 12 0C5.37258 0 0 5.37258 0 12C0 18.6274 5.37258 24 12 24ZM16.3788 10.6778L13.3203 7.61848C13.1914 7.48959 12.9812 7.48959 12.8523 7.61848L6.35352 14.1191L6.00426 17.2665C5.95679 17.6871 6.31283 18.0432 6.73329 17.9957L9.88001 17.6464L16.3788 11.1458C16.5077 11.0169 16.5077 10.8066 16.3788 10.6778ZM17.1587 5.18665L18.8134 6.84178C19.3289 7.35732 19.3289 8.19506 18.8134 8.71399L17.6131 9.91464C17.4842 10.0435 17.274 10.0435 17.1451 9.91464L14.0866 6.85535C13.9577 6.72647 13.9577 6.51618 14.0866 6.3873L15.287 5.18665C15.8058 4.67112 16.6433 4.67112 17.1587 5.18665Z" />
                    </svg>
                  </button>
                  <div class="modal fade" id="address" tabindex="-1" aria-labelledby="Введите адрес доставки товара"
                    aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                          <form action="#" class="modal-form">
                            <div class="form__wrapper">
                              <input type="text" aria-label="Введите название города" placeholder="Город"
                                class="form__input input-reset">
                              <input type="text" aria-label="Введите название транспортной компании"
                                placeholder="Транспортная компания" class="form__input input-reset">
                              <input type="text" aria-label="Введите предпочтительный терминал в городе"
                                placeholder="Предпочтительный терминал в городе" class="form__input input-reset">
                              <textarea name="#" id="#" cols="30" rows="5" aria-label="Введите комментарии к отправке"
                                placeholder="Комментарии к отправке" class="form__input input-reset"></textarea>
                              <div class="modal-footer">
                                <button class="form__button button btn-reset">Сохранить</button>
                                <button class="form__button form__button--close button btn-reset"
                                  data-bs-dismiss="modal">Отмена</button>
        ...
        <div class="row mb-5">
          <div class="col">
            <div class="wholesalers-account__container">
              ...
              <button class="wholesalers-account__change btn-reset" data-bs-toggle="modal" data-bs-target="#requisites"
                aria-label="Нажмите, чтобы изменить данные">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" clip-rule="evenodd"
                    d="M12 24C18.6274 24 24 18.6274 24 12C24 5.37258 18.6274 0 12 0C5.37258 0 0 5.37258 0 12C0 18.6274 5.37258 24 12 24ZM16.3788 10.6778L13.3203 7.61848C13.1914 7.48959 12.9812 7.48959 12.8523 7.61848L6.35352 14.1191L6.00426 17.2665C5.95679 17.6871 6.31283 18.0432 6.73329 17.9957L9.88001 17.6464L16.3788 11.1458C16.5077 11.0169 16.5077 10.8066 16.3788 10.6778ZM17.1587 5.18665L18.8134 6.84178C19.3289 7.35732 19.3289 8.19506 18.8134 8.71399L17.6131 9.91464C17.4842 10.0435 17.274 10.0435 17.1451 9.91464L14.0866 6.85535C13.9577 6.72647 13.9577 6.51618 14.0866 6.3873L15.287 5.18665C15.8058 4.67112 16.6433 4.67112 17.1587 5.18665Z" />
              ...
              <div class="modal fade" id="requisites" tabindex="-1" aria-labelledby="Введите реквизиты"
                aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                      <form action="#" class="modal-form">
                        <div class="form__wrapper">
                          <input type="text" aria-label="Введите наименование организации (краткое)"
                            placeholder="Наименование организации (краткое)" class="form__input input-reset">
                          <input type="text" aria-label="Введите ИНН/КПП" placeholder="ИНН/КПП"
                            class="form__input input-reset">
                          <input type="tel" aria-label="Введите номер телефона" placeholder="Телефон"
                            class="form__input input-reset">
                          <input type="text" aria-label="Введите юридический и фактический адрес"
                            placeholder="Юридический и фактический адрес" class="form__input input-reset">
                          <input type="text" aria-label="Введите почтовый адрес" placeholder="Почтовый адрес"
                            class="form__input input-reset">
                          <input type="text" aria-label="Введите расчетный счет" placeholder="Расчетный счет"
                            class="form__input input-reset">
                          <input type="text" aria-label="Введите корреспондентский счет"
                            placeholder="Корреспондентский счет" class="form__input input-reset">
                          <input type="text" aria-label="Введите БИК" placeholder="БИК" class="form__input input-reset">
                          <input type="text" aria-label="Введите название банка" placeholder="Банк"
                            class="form__input input-reset">
                          <input type="text" aria-label="Введите ОКВЭД" placeholder="ОКВЭД"
                            class="form__input input-reset">
                          <input type="text" aria-label="Введите ОКПО" placeholder="ОКПО"
                            class="form__input input-reset">
                          <input type="text" aria-label="Введите ОГРН" placeholder="ОГРН"
                            class="form__input input-reset">
                          <div class="modal-footer">
                            <button class="form__button button btn-reset">Сохранить</button>
                            <button class="form__button form__button--close button btn-reset"
